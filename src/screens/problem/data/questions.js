const QUESTIONS = {
  ...
  164:(<div class="elfjS" data-track-load="description_content"><p>Given an integer array <code>nums</code>, return <em>the maximum difference between two successive elements in its sorted form</em>. If the array contains less than two elements, return <code>0</code>.</p>
  ...
  <pre><strong>Input:</strong> nums = [3,6,9,1]<br/>
  ...
  <pre><strong>Input:</strong> nums = [10] <br/>
