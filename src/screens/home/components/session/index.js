    ...
    >
      ...
      >
        ...
        >
          <ProgressCont>
            <AllText>All</AllText>
            <TotalScoreText>3221</TotalScoreText>
            <Divider />
            <SessionScoreText>3221</SessionScoreText>
          </ProgressCont>
        </CircularProgressbarWithChildren>
      </CircularProgressbarWithChildren>
    </CircularProgressbarWithChildren>
          ...
          <StatsContainer>
            ...
            <StatsContent>
              <TextContainer>
                ...
                <ScoreTextContainer>
                  <ScoreText>811</ScoreText>
                  <TotalText>/811</TotalText>
                </ScoreTextContainer>
              </TextContainer>
              <TextContainer>
                <LevelText medium>Medium</LevelText>
                <ScoreTextContainer>
                  <ScoreText>1692</ScoreText>
                  <TotalText>/1692</TotalText>
                </ScoreTextContainer>
              </TextContainer>
              <TextContainer>
                <LevelText>Hard</LevelText>
                <ScoreTextContainer>
                  <ScoreText>718</ScoreText>
                  <TotalText>/718</TotalText>
                </ScoreTextContainer>
              </TextContainer>
            </StatsContent>
          </StatsContainer>
